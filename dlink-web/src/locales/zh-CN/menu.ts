...
export default {
  ...
  'menu.resource': '资源中心',
  'menu.resource.flink': 'Flink 管理',
  'menu.resource.flink.clusterInstance': 'Flink Session管理',
  'menu.resource.flink.clusterConfiguration': 'Flink集群管理',
  'menu.resource.flink.flinkConfig': 'Flink 配置',
  'menu.resource.flink.udfTemplate': 'UDF 模板配置',
