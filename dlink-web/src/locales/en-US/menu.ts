...
export default {
  ...
  'menu.registration.cluster': 'Flink Management',
  'menu.registration.cluster.clusterInstance': 'Flink Session',
  'menu.registration.cluster.clusterConfiguration': 'Flink Cluster',
  'menu.registration.cluster.flinkConfig': 'Flink Settings',
  'menu.registration.cluster.udfTemplate': 'UDF Template Settings',
