...
const SchedulerTaskInfo = (props: any) => {
    ...
    <>
      ...
      <Scrollbars style={{height: (toolHeight - 32)}}>
        <Descriptions bordered size="small" column={1}>
          <Descriptions.Item label={l('pages.Scheduler.label.jobInfo.id')}>
            <Paragraph copyable>{current.task.id}</Paragraph>
          </Descriptions.Item>
          <Descriptions.Item label={l('pages.Scheduler.label.jobInfo.name')}>
            {current.task.alias}
          </Descriptions.Item>
          <Descriptions.Item label={l('pages.Scheduler.label.jobInfo.versionId')}>
