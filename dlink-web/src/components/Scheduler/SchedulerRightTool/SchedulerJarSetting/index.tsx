...
const SchedulerJarSetting = (props: any) => {
    ...
    <>
      ...
      <Scrollbars style={{height: (toolHeight - 32)}}>
        ...
        >
          ...
          <Form.Item label={<>{l('pages.Scheduler.label.jobConfig.jar')} </>}
                     tooltip={l('pages.Scheduler.label.jobConfig.jar.tip1', '', {
                       type: current.task.type
                     })}
                     className={styles.form_item}>
            <Form.Item name="jarId" noStyle>
              <Select
                style={{width: '80%'}}
                placeholder={l('pages.Scheduler.label.jobConfig.jar.tip2')}
                allowClear
                optionLabelProp="label"
              >
                {getJarOptions()}
