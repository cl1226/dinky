...
const SchedulerEnvSetting = (props: any) => {
      ...
      <Scrollbars style={{height: (toolHeight - 32)}}>
        ...
        >
          <Row>
            <Col span={12}>
              <Form.Item
                label={l('pages.Scheduler.label.jobConfig.fragment')} className={styles.form_item} name="fragment" valuePropName="checked"
                tooltip={{
...
export default connect(({Scheduler, Jar}: { Scheduler: StateType, Jar: JarStateType }) => ({
