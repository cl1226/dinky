...
const SchedulerSqlConfig = (props: any) => {
    ...
    <>
      ...
      <Scrollbars style={{height: (toolHeight - 32)}}>
        ...
        >
          <Row>
            <Col span={24}>
              <Form.Item label={l('pages.Scheduler.label.datasource')} tooltip={l('pages.Scheduler.label.execConfig.selectDatabase.tip')}
                         name="databaseId"
                         className={styles.form_item}>
                <Select
                  style={{width: '100%'}}
                  placeholder={l('pages.Scheduler.label.execConfig.selectDatabase')}
            ...
            <Col span={24}>
              <Form.Item
                label={l('pages.Scheduler.label.maxrows')} className={styles.form_item} name="maxRowNum"
