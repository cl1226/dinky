...
import {MetaStoreTableType, StateType} from "@/pages/Scheduler/model";
...
import {getMSSchemaInfo} from "@/pages/Scheduler/service";
...
const SchedulerMetaStore = (props: any) => {
...
const mapDispatchToProps = (dispatch: Dispatch) => ({
  saveMetaStoreTable: (activeKey: number, catalog: string, database: string, tables: MetaStoreTableType[]) => dispatch({
    type: "Scheduler/saveMetaStoreTable",
    payload: {
      activeKey,
      catalog,
      database,
...
}), mapDispatchToProps)(SchedulerMetaStore);
