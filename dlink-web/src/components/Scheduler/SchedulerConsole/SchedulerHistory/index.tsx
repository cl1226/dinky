...
import {getJobData} from "@/pages/Scheduler/service";
import {HistoryItem} from "@/components/Scheduler/SchedulerConsole/SchedulerHistory/data";
...
const SchedulerHistory = (props: any) => {
  ...
  const removeHistory = (row: HistoryItem) => {
    Modal.confirm({
      title: l('pages.Scheduler.label.history.delete'),
      content: l('pages.Scheduler.label.history.deleteConfirm'),
  ...
  return (
    <>
      <ProList<HistoryItem>
        ...
        rowKey="id"
        headerTitle={l('pages.Scheduler.label.history.exec')}
        ...
        metas={{
          ...
          actions: {
            render: (text, row) => [
              <a key="config" onClick={() => {
                ...
                {l('pages.Scheduler.label.history.execConfig')}
              </a>,
              <a key="statement" onClick={() => {
                showDetail(row, 2)
              }}>
                {l('pages.Scheduler.label.history.statement')}
              </a>,
              <a key="result" onClick={() => {
                showDetail(row, 3)
              }}>
                {l('pages.Scheduler.label.history.result')}
              </a>,
              <a key="error" onClick={() => {
                showDetail(row, 4)
              }}>
                {l('pages.Scheduler.label.history.error')}
              </a>,
          ...
          jobName: {
            dataIndex: 'jobName',
            title: l('pages.Scheduler.label.history.jobName'),
          },
          clusterId: {
            dataIndex: 'clusterId',
            title: l('pages.Scheduler.label.history.runningCluster'),
          },
          session: {
            dataIndex: 'session',
            title: l('pages.Scheduler.label.history.session'),
          },
          status: {
      ...
      >
        {type == 1 && (
          <ProDescriptions
            column={2}
            title={l('pages.Scheduler.label.history.execConfig')}
          >
            ...
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.session')}>
            ...
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.taskType')}>
              {config.type}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.clusterId')}>
              {config.clusterId}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.clusterConfigId')}>
              {config.clusterConfigurationId}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.result')}>
              {config.useResult ? l('button.enable') : l('button.disable')}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.changelog')}>
              {config.useChangeLog ? l('button.enable') : l('button.disable')}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.maxRow')}>
              {config.maxRowNum}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.autoStop')}>
              {config.useAutoCancel ? l('button.enable') : l('button.disable')}
            </ProDescriptions.Item>
            <ProDescriptions.Item span={2} label="JobManagerAddress">
              {row.jobManagerAddress}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.jobId')}>
              {config.taskId}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.jobName')}>
              {config.jobName}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.useStatementSet')}>
              {config.useSqlFragment ? l('button.enable') : l('button.disable')}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.useSqlFragment')}>
              {config.useStatementSet ? l('button.enable') : l('button.disable')}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.parallelism')}>
              {config.parallelism}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.checkpoint')}>
              {config.checkpoint}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.savePointStrategy')}>
              {config.savePointStrategy}
            </ProDescriptions.Item>
            <ProDescriptions.Item label={l('pages.Scheduler.label.history.savePointPath')}>
        ...
        {type == 2 && (
          <ProDescriptions
            column={1}
            title={l('pages.Scheduler.label.history.statement')}
          >
        ...
        {type == 3 && (
          <ProDescriptions
            column={2}
            title={l('pages.Scheduler.label.history.result')}
          >
            <ProDescriptions.Item span={2} label="JobId">
              <Tag color="blue" key={row.jobId}>
                <FireOutlined/> {row.jobId}
            ...
            <ProDescriptions.Item span={2}>
              <SchedulerPreview result={result} style={{width: '100%'}}/>
            </ProDescriptions.Item>
          </ProDescriptions>
        )}
        {type == 4 && (
          <ProDescriptions
            column={1}
            title={l('pages.Scheduler.label.history.error')}
          >
            <ProDescriptions.Item label="JobId">
              <Tag color="blue" key={row.jobId}>
                <FireOutlined/> {row.jobId}
