...
import { clearConsole } from "../../SchedulerEvent/DDL";
import {l} from "@/utils/intl";

const SchedulerMsg = (props: any) => {
  ...
  const editorDidMountHandle = (editor: any, monaco: any) => {
    editor.addAction({
      id: 'btn-Scheduler-msg-clear', // menu id
      label: l('pages.Scheduler.editor.clearConsole'), // menu name
