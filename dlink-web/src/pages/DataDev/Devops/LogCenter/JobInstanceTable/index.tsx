...
import { JobInstanceTableListItem } from '@/pages/DataDev/Devops/LogCenter/data.d'
...
import OpsStatusModal from '@/pages/DataDev/Devops/LogCenter/OpsStatusModel/index'
import StatusDetailedModal from '@/pages/DataDev/Devops/LogCenter/StatusDetailedModel/index'
import {
  onClickOperatingTask,
  queryAllCatalogue,
  queryOneClickOperatingTaskStatus,
} from '@/pages/DataDev/Devops/LogCenter/service'
    ...
    <>
      <ProTable
        ...
        onRow={(record) => {
          return {
            onClick: (event) => {
              history.push(`/dataDev/devops/JobInfo?id=${record.id}`)
            },
          }
        }}
      />
