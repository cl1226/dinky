...
import Tables from '@/pages/Resource/DataBase/Tables'
import Columns from '@/pages/Resource/DataBase/Columns'
import Divider from 'antd/es/divider'
import Generation from '@/pages/Resource/DataBase/Generation'
import { FALLBACK, getDBImage } from '@/pages/Resource/DataBase/DB'

import TableData from '@/pages/DataAsset/MetaDataCenter/TableData'
import Meta from 'antd/lib/card/Meta'
import { l } from '@/utils/intl'
import Console from '@/pages/DataAsset/MetaDataCenter/Console'
