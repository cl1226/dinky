...
import {AlertInstanceTableListItem} from "@/pages/Resource/data";
import {connect} from "umi";
import {ALERT_CONFIG_LIST, ALERT_TYPE, AlertConfig} from "@/pages/Resource/AlertManage/AlertInstance/conf";
import {getAlertIcon} from "@/pages/Resource/AlertManage/AlertInstance/icon";
import {AlertStateType} from "@/pages/Resource/AlertManage/AlertInstance/model";
import DingTalkForm from "@/pages/Resource/AlertManage/AlertInstance/components/DingTalkForm";
import {createOrModifyAlertInstance, sendTest} from "@/pages/Resource/AlertManage/AlertInstance/service";
import WeChatForm from "@/pages/Resource/AlertManage/AlertInstance/components/WeChatForm";
import FeiShuForm from "@/pages/Resource/AlertManage/AlertInstance/components/FeiShuForm";
import EmailForm from "@/pages/Resource/AlertManage/AlertInstance/components/EmailForm";
