...
import { UserTableListItem } from '@/pages/SuperAdmin/type.d'
import UserForm from '@/pages/SuperAdmin/User/components/UserForm'
import PasswordForm from '@/pages/SuperAdmin/User/components/PasswordForm'
import TableTransferFrom from '@/pages/SuperAdmin/User/components/TableTransfer'
...
const UserTableList: React.FC<{}> = (props: any) => {
  ...
  return (
    <>
      <PageWrap backgroundColor="transparent" noScroll={true}>
        <ProTable<UserTableListItem>
          ...
          request={(params, sorter, filter) => queryData(url, { ...params, sorter, filter } as any)}
          columns={columns}
          rowSelection={{
